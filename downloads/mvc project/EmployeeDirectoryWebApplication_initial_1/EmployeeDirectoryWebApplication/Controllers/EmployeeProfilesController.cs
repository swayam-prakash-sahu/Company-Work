...
namespace EmployeeDirectoryWebApplication.Controllers
{
    ...
    public class EmployeeProfilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmployeeId,UserId,EmployeeName,DesignationId,DeptId,ManagerId,EmployeeProfilePic,EmploymentStatus,CreatedDate,CreatedBy,UpdatedDate,UpdatedBy")] EmployeeProfile employeeProfile)
        {
            if (ModelState.IsValid)
            {

               // employeeProfile.UserId = GetCurrentUserId();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,UserId,EmployeeName,DesignationId,DeptId,ManagerId,EmployeeProfilePic,EmploymentStatus,CreatedDate,CreatedBy,UpdatedDate,UpdatedBy")] EmployeeProfile employeeProfile)
        {
